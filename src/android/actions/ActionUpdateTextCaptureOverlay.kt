...
class ActionUpdateTextCaptureOverlay(private val textCaptureModule: TextCaptureModule) : Action {

    override fun run(args: JSONArray, callbackContext: CallbackContext) {
        textCaptureModule.updateOverlay(args[0].toString(), CordovaResult(callbackContext))
    }
}
